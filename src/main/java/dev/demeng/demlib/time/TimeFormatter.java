package dev.demeng.demlib.time;

import lombok.Getter;

/** Utility for converting seconds into an easy to understand format. */
public final class TimeFormatter {

  @Getter private final long totalSeconds;

  @Getter private final long years;
  @Getter private final long months;
  @Getter private final long weeks;
  @Getter private final long days;
  @Getter private final long hours;
  @Getter private final long minutes;
  @Getter private final long seconds;

  public TimeFormatter(long totalSeconds) {
